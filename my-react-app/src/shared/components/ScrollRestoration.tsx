...
// Track scroll positions and navigation history to restore scroll position on
// back/forward navigation. React Router's built-in scroll restoration doesn't
// reliably track back-button navigation in all cases.
